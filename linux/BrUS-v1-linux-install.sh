...
EOF
    ...
    if [ "$DETECTED_ENV" = "hyprland" ]; then
        ...
        if [ "$XDG_SESSION_TYPE" = "wayland" ]; then
            ...
            echo "───────────────────────────────────────────────────────────────────────────"
            echo "Para ativar o layout:"
            echo ""
            echo "OPÇÃO 1 - Via script (recomendado):"
            echo "  Execute novamente o instalador e escolha 's' para ativar"
            echo ""
            echo "OPÇÃO 2 - Via Configurações do Sistema:"
            echo "  Menu → Configurações do Sistema"
            echo "  Dispositivos de Entrada → Teclado → Layouts"
            echo "  Adicione: Português (Brasil, BrUS-v1)"
            echo ""
        ...
        if [ "$XDG_SESSION_TYPE" = "wayland" ]; then
            ...
            echo "  Execute novamente o instalador e escolha 's' para ativar"
            echo ""
            echo "OPÇÃO 2 - Via Configurações:"
            echo "  Menu → Configurações → Teclado → Layout"
            echo "  Adicione: Português (Brasil, BrUS-v1)"
            echo ""
            echo "═══════════════════════════════════════════════════════════════════════════"
        ...
        echo "OPÇÃO 1 - Via script (recomendado):"
        echo "  Execute novamente o instalador e escolha 's' para ativar"
        echo "  (Irá configurar automaticamente via gsettings)"
        echo ""
        echo "OPÇÃO 2 - Via interface gráfica:"
    ...
    echo "  Execute novamente o instalador e escolha 's' para criar o script de ativação"
    echo "  Depois adicione às aplicações de inicialização do seu ambiente"
    echo ""
